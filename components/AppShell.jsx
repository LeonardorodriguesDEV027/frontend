...
const nav = [
  ...
  ['/app/chat', 'bi-chat-dots', 'Chat']
];
// "Administração" só aparece para quem é admin (o 4º item indica isso).
const adminNav = ['/app/admin', 'bi-gear', 'Administração', true];
export default function AppShell() {
  ...
  // Monta o menu: todos veem os itens comuns; só admin vê "Administração".
  const menu = user?.tipoUsuario === 'admin' ? [...nav, adminNav] : nav;
  return (
    <div className="shell">
